...
*  	TODO: Restart button
*  	TODO: RESET - release game object, unlink ingame.js
*  	TODO: QUIT - add button quit to menu
*
* 
...
displayOptions ("");
addToMenu("menu","Reset", "game.state.start('default)", "whatever");
addToMenu("menu","Quit", "dynamicUnload('./lib/ingame.js','js'); game.destroy();", "whatever");
