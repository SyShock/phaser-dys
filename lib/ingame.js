...
var inGame = {
	...
	preload: function() {
		...
		game.load.spritesheet('buttonvertical', 'assets/img/buttons/button-vertical.png',64,64);
		game.load.spritesheet('buttonhorizontal', 'assets/img/buttons/button-horizontal.png',96,64);
		game.load.spritesheet('buttondiagonal', 'assets/img/buttons/button-diagonal.png',64,64);
		game.load.spritesheet('buttonfire', 'assets/img/buttons/button-round-a.png',96,96);
		game.load.spritesheet('buttonjump', 'assets/img/buttons/button-round-b.png',130,120);
...
//		game.scale.fullScreenScaleMode = Phaser.ScaleManager.SCALE;
	...
	//	playTrack('/tracks/250526838');
		...
		player = new Player(0, game, 'player', maps.player[0].position.x,
				maps.player[0].position.y, null, true, 0.2, 1, 0.3, 200, 0.1);    
