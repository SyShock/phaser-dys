...
function virtualButtons() {
    ...
    buttonjump = game.add.button(1100, 500, 'buttonjump', null, this, 0, 1, 0, 1);  //game, x, y, key, callback, callbackContext, overFrame, outFrame, downFrame, upFrame
    ...
    buttonfire = game.add.button(900, 500, 'buttonfire', null, this, 0, 1, 0, 1);
